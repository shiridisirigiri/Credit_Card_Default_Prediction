...
#         sl.download_button(label='Download tabel', data=data_frame, mime='text/csv',
...
#
# # Selection
# rad_b = sl.radio('Please select that you want give Single  customers data', options=['Singel'])
#
#
